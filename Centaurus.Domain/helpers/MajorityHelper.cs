...
namespace Centaurus
{
    ...
    {
        public static int GetMajorityCount(this CentaurusContext context)
        {
            if (context == null)
        ...
        public static int GetTotalAuditorsCount(this CentaurusContext context)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static bool HasMajority(this CentaurusContext context, MessageEnvelope envelope)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
