...
namespace Centaurus.Domain
{
    ...
    {
        public static SettingsModel ToProviderModel(this ProviderSettings providerSettings, string lastCursor)
        {
            ...
            return new SettingsModel
            {
                ...
                Cursor = lastCursor == null ? providerSettings.InitCursor : lastCursor,
